  ...
  const handleGitHubExport = async () => {
    ...
    if (!cleanToken) {
      ...
      setExportLogs([
        ...
        "  3. Copiez le token ghp_<REDACTED_GITHUB_PERSONAL_ACCESS_TOKEN>... et collez-le dans le champ de saisie ci-dessus !",
        "───────────────────────────────────────────────────",
      ...
      for (let index = 0; index < operations.length; index++) {
        ...
        if (!isBinaryFile) {
          if (activeSanitize) {
            ...
            rawContent = rawContent.replace(/process.env.JWT_SECRET || "<REDACTED_SOUVERAIN_JWT_SECRET_SET_VIA_ENV_VARIABLE>"/g, 'process.env.JWT_SECRET || "<REDACTED_SOUVERAIN_JWT_SECRET_SET_VIA_ENV_VARIABLE>"');
            rawContent = rawContent.replace(/<REDACTED_SOUVERAIN_JWT_SECRET>/g, '<REDACTED_SOUVERAIN_JWT_SECRET>');
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="ghp_<REDACTED_GITHUB_PERSONAL_ACCESS_TOKEN>"
